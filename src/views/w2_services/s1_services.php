    ...
    <wrapper>
        ...
        <div class="swiper-sticky" from-swiper="services">
            ...
            <div class="swiper-paso" paso="1">
                <img id="w2_s2_t1_e1_img" alt="Coordinador" src="/img/img-floating/w2_services/m/CTS_11.png" lazy-src="/img/img-floating/w2_services/CTS_11.png">
                <img id="w2_s2_t1_e2_img" alt="Psicologa" src="/img/img-floating/w2_services/m/CTS_12.png" lazy-src="/img/img-floating/w2_services/CTS_12.png">

                <anim id="w2_s2_t1_e1_obj" alt="Rayitas de Psicologo"></anim>
                <div class="mobile">

                </div>
                <div class="desktop">
                    <anim id="w2_s2_t1_e2_obj" alt="Rayitas de Psicologa"></anim>
                </div>
            </div>

            <div class="swiper-paso" paso="2">
                <img id="w2_s2_t2_e1_img" alt="Niña Biblioteca" src="/img/img-floating/w2_services/m/CTS_13.png" lazy-src="/img/img-floating/w2_services/CTS_13.png">
                <img id="w2_s2_t2_e2_img" alt="Libros" src="/img/img-floating/w2_services/m/CTS_14.png" lazy-src="/img/img-floating/w2_services/CTS_14.png">
                <anim id="w2_s2_t2_e1_obj" alt="Birrete animado"></anim>
                <div class="mobile">

                </div>
                <div class="desktop">   
                    <anim id="w2_s2_t2_e2_obj" alt="Bigotes"></anim>
                </div>
            </div>
            <div class="swiper-paso" paso="3">
                <img id="w2_s2_t3_e1_img" alt="Manzana" src="/img/img-floating/w2_services/m/CTS_15.png" lazy-src="/img/img-floating/w2_services/CTS_15.png">
                <img id="w2_s2_t3_e2_img" alt="Señora Cafeteria" src="/img/img-floating/w2_services/m/CTS_16.png" lazy-src="/img/img-floating/w2_services/CTS_16.png">
            ...
            <div class="swiper-paso" paso="4">
                <img id="w2_s2_t4_e1_img" alt="Niños Primera Comunion" src="/img/img-floating/w2_services/m/CTS_18.png" lazy-src="/img/img-floating/w2_services/CTS_18.png">
                ...
                <div class="desktop"> 
                 <img id="w2_s2_t4_e2_img" alt="Biblia" src="/img/img-floating/w2_services/m/CTS_17.png" lazy-src="/img/img-floating/w2_services/CTS_17.png">
                </div>
            </div>
        </div>
